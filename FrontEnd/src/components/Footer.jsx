        ...
        <div>
            ...
            <div className="flex-1 relative sm:flex-col flex-row">
                <div className="bg-gray-100 h-full " style={{ backgroundImage: "url(https://cdn.pixabay.com/photo/2024/02/19/08/49/hibiscus-8582876_1280.jpg)", backgroundSize: "cover" }}>
                    ...
                    <div className="h-full flex flex-col mt-10   justify-center items-center  " style={{ backdropFilter: "blur(5px)" }}>
            ...
            <div className="flex-1">
                <div className="bg-gray-200 h-full  sm:mt-10 p-10 ">
                    ...
                    <div className="h-full flex flex-col md:flex-row justify-around items-center">
                        ...
                        <div className='flex flex-col justify-center  text-center'>
                            <h1 className='text-xl bg-gray-300 px-4 py-1 rounded-lg mb-4 font-bold '>Community</h1>
                        ...
                        <div className='flex flex-col justify-center  text-center'>
                            <h1 className='text-xl bg-gray-300 px-4 py-1 rounded-lg mb-4 font-bold '>More</h1>
